					...
					<div className="flex flex-col justify-center items-center">
						<div className="flex-grow mt-8">
							...
							<div className="max-w-2xl  md:mr-10">
								<h1 ref={this.element} className="text-lg md:text-2xl lg:text-3xl my-4 md:my-8  text-yellow-400 text-center uppercase tracking-widest banner-header ">{bannerHeading}</h1>
								<div className="font-black text-white text-3xl md:text-4xl lg:text-6xl text-center uppercase banner-subheading">{bannerInfo}</div>
							</div>
						</div>
					</div>
				</div>
